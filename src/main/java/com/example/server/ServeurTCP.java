...
import com.example.server.ProtocolePuissance4;
import com.example.server.UnContexte;
...
public class ServeurTCP extends Thread{
	...
	public ServeurTCP(UnContexte unContexte, ProtocolePuissance4 protocolePuissance4, int unNumeroPort) {
		numeroPort = unNumeroPort;
		maxConnexions = 2;
	} 

	public ServeurTCP(IContext b,IProtocole p, int port) {
		this.numeroPort = port;
		contexte = b;
		protocole = p;
	}
